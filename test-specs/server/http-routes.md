...
- `GET /admin/images` renders image management `[integration]` **P0**
...
- `GET /admin/images/upload` renders upload form with model dropdown `[integration]` **P0**
- `POST /admin/images/upload` accepts multipart form data and imports image `[integration]` **P0**
