...
async fn test_delete_lab_by_id() -> Result<()> {
    ...
    let lab = create_lab(&db, "Test Lab", "lab-0002", &user, "127.127.1.0/24").await?;
...
async fn test_delete_lab_decreases_count() -> Result<()> {
    ...
    create_lab(&db, "Lab 1", "lab-0003", &user, "127.127.1.0/24").await?;
    let lab2 = create_lab(&db, "Lab 2", "lab-0004", &user, "127.127.2.0/24").await?;
...
async fn test_delete_lab_cascade_removes_nodes() -> Result<()> {
    ...
    let lab = create_lab(&db, "Test Lab", "lab-0005", &user, "127.127.1.0/24").await?;
...
async fn test_delete_lab_safe_with_nodes_fails() -> Result<()> {
    ...
    let lab = create_lab(&db, "Test Lab", "lab-0006", &user, "127.127.1.0/24").await?;
...
async fn test_delete_lab_safe_empty_succeeds() -> Result<()> {
    ...
    let lab = create_lab(&db, "Empty Lab", "lab-0007", &user, "127.127.1.0/24").await?;
...
async fn test_delete_lab_cascade_full() -> Result<()> {
    ...
    let lab = create_lab(&db, "Full Lab", "lab-0008", &user, "127.127.1.0/24").await?;
...
async fn test_delete_lab_with_cascade_in_schema() -> Result<()> {
    ...
    let lab = create_lab(&db, "Auto Cascade Lab", "lab-0009", &user, "127.127.1.0/24").await?;
