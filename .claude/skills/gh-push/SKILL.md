...
Push the current branch to GitHub, using the GH_TOKEN for authentication.
...
Run `git status` to confirm there are commits to push. Show the current branch name
and how many commits ahead of the remote it is.
