...
pub const SHERPA_MANAGEMENT_NETWORK_IPV4: &str = "192.168.128.0/22";
pub const SHERPA_MANAGEMENT_DNSMASQ_IPV4_INDEX: u32 = 5;
pub const SHERPA_MANAGEMENT_WEBDIR_IPV4_INDEX: u32 = 6;
...
pub const CONTAINER_DNSMASQ_NAME: &str = "dnsmasq";
pub const CONTAINER_DNSMASQ_REPO: &str = "docker.io/dockurr/dnsmasq";
pub const CONTAINER_DNSMASQ_VERSION: &str = "2.91";
