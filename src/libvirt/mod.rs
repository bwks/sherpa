...
pub use crate::libvirt::template::{
    ArubaAoscxTemplate, CiscoAsavZtpTemplate, CiscoIosvZtpTemplate, CiscoIosxrZtpTemplate,
    CiscoNxosZtpTemplate, CloudInitTemplate, DomainTemplate, JunipervJunosZtpTemplate,
};
